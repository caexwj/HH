...
- (void)drawRect:(CGRect)rect{
    ...
    CGColorRef controllcolor = [[UIColor darkGrayColor] CGColor];
    const CGFloat *bgRef = CGColorGetComponents(controllcolor);
    ...
    if (self.selected){
        ...
        CGContextClosePath (context);
        CGContextClip (context);
        CGColorRef selectcolor = [[UIColor redColor] CGColor];
        const CGFloat *selRef = CGColorGetComponents(selectcolor);
